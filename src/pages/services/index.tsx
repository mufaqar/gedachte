    ...
    return (
        <main>
            ...
            <motion.section
                ...
                viewport={{ once: true, amount: 0.3 }}
                transition={{ staggerChildren: 0.1 }}
                className='py-20 relative bg-sky-100'>
                ...
                <div className='container mx-auto px-4 grid md:grid-cols-2 grid-cols-1 gap-5 justify-between'>
                    ...
                    <div className='grid gap-16'>
                        <motion.div
                            variants={fadeUp}
                            className="md:p-[32.27px] px-3 py-[32.27px] max-w-[490px] mx-auto bg-white rounded-2xl flex-col justify-center items-start gap-[42.41px] flex w-full">
            ...
            <motion.section
                ...
                <div className='container mx-auto bg-sky-100 rounded-[20px] md:p-10 md:pb-20 pt-16 pb-16 px-3'>
                    <div>
                        <motion.h2
                            variants={fadeUp}
                            className="max-w-[636px] mx-auto text-center text-sky-900 text-[32px] font-semibold leading-[52px]">
                            Gespecialiseerde Workshops
                        </motion.h2>
                        <motion.p
                            variants={fadeUp}
                            className="max-w-[516px] mx-auto text-center text-sky-900 md:text-[22px] text-lg font-normal leading-[39px] tracking-wide mt-10">
            ...
            <motion.section
                ...
                <div className='container mx-auto px-4 grid md:grid-cols-2 grid-cols-1 gap-5 justify-between'>
                    ...
                    <motion.div
                        variants={fadeUp}
                        className='grid gap-16 md:order-2 order-1'>
